...
CREATE TABLE VEHICULO (
    IDVEH int auto_increment,
    PLAVEH char(7),
    SOATVEH char(24),
    MARVEH varchar(50),
    CONSTRAINT VEHICULO_pk PRIMARY KEY (IDVEH)
);
...
CREATE TABLE VIAJE (
    ...
    DIRVIA varchar(50),
    CODUBI char(6),                           		
    CONSTRAINT VIAJE_pk PRIMARY KEY (IDVIA)
);

-- foreign keys
-- Reference: CLIENTE_UBIGEO (table: CLIENTE)
ALTER TABLE CLIENTE ADD CONSTRAINT CLIENTE_UBIGEO FOREIGN KEY CLIENTE_UBIGEO (CODUBI)
...
ALTER TABLE VENDEDOR ADD CONSTRAINT VENDEDOR_UBIGEO FOREIGN KEY VENDEDOR_UBIGEO (CODUBI)
    REFERENCES UBIGEO (CODUBI);
...
ALTER TABLE VENTA ADD CONSTRAINT VENTA_VENDEDOR FOREIGN KEY VENTA_VENDEDOR (IDVEN)
    REFERENCES VENDEDOR (IDVEN);

-- Reference: VENTA_VIAJE (table: VENTA)
...
Insert into CLIENTE
     (DOCUCLI,NOMCLI,APECLI,CELCLI,EMACLI,FECCLI,SEXCLI,ESTCLI,CODUBI)
values
    ('71093166','kimberling','lipa','934747611','kimberling.yactayo@vallegrande.edu.pe','2002-05-05','F','A','250201'),
    ('71592352','Jhonn','Sotomayor','934362627','Jhonn.sotomayor@vallegrande.edu.pe','2003-03-15','M','A','250201'),
    ('73153926','Carlos','Galvan','937237131','Carlos.Galvan@vallegrande.edu.pe','2000-08-04','M','A','250401'),
    ('71093166','Angie','Cepeda','993852361','Angie.Cepeda@vallegrande.edu.pe','1980-12-10','F','A','250303'),
    ('72533618','Cristian','Dominguez','983351861','Cristian.Dominguez@vallegrande.edu.pe','2002-05-05','M','A','250201'),
    ('72281151','Francisco','Ramirez','992821158','Francisco.Ramirez','2000-02-15','M','A','200801'),
    ('71093166','Luis','Orellana','911259925','Luis.orellana@vallegrande.edu.pe','1980-04-09','M','A','200705'),
    ('74429788','William','Taipe','992285178','William.taipe@vallegrande.edu.pe','2000-09-27','M','A','200702'),
    ('15388159','Cristofer','Porras','993388197','Cristofer.porras@vallegrande.edu.pe','2000-12-08','M','A','200607'),
    ('73369285','Karla','Sanchez','939952795','Karla.sanchez@vallegrande.edu.pe','1995-03-22','F','A','250201');

select * from Cliente;

Insert into CONDUCTOR
      (DOCCON,NOMCON,APECON,CELCON,EMACON,SEXCON,ESTCON,FECCON,LICECON,TARCON,CODUBI)
values
      ('71093166','Marcelino','Sanchez','934747839','mareclino.sanchez@gmail.com','M','A','1975-03-13','k987654381','45654321','200608'),
      ('43568912','Maria','Lira','934098634','maria.lira@gmail.com','F','A','1970-02-01','k987654367','77654322','200608'),
      ('32456134','Pedro','Quispe','923457789','pedro.quispe@gmail.com','M','A','1980-09-15','F987654334','88653210','190207'),
      ('77342179','Amelia','Ramos','934747208','amelia.ramos@gmail.com','F','A','1980-02-15','J987654308','67654388','190207'),
      ('50345677','Juana','Yactayo','934746676','juana.yactayo@gmail.com','F','A','1990-09-25','L987654376','87654456','160705'),
      ('41278976','Jhon','Cuzcano','934098849','jhon.cuzcano@gmail.com','M','A','1973-06-12','W987654332','89654319','180101'),
      ('06782345','Nicolas','Santacruz','934723513','nicolas.santacruz@gmail.com','M','A','1977-09-24','R987652420','87654301','150108'),
      ('66789234','Sebastian','Valenzuela','934767800','sebastian.valenzuela@gmail.com','M','A','1980-05-22','Q987655321','87344321','150104'),
      ('21093166','Rosario','Campos','934098721','rosario.campos@gmail.com','F','A','1973-03-30','S287654321','87656781','140308'),
      ('01093166','Luz','Casas','934743457','luz.casas@gmail.com','M','A','1993-07-28','N980954321','07654321','120205');

select * from Conductor;


Insert into VENDEDOR
      (DOCVEN,NOMVEN,APEVEN,CELVEN,EMAVEN,FECVEN,SEXVEN,ESTVEN,CODUBI)
values
	 ('71288481','Jesus','Canales','922947157','Jesus.canales@vallegrande.edu.pe','1970-05-12','M','A','021206'),
     ('79876542','Phill','Foden','938835259','Phill.foden@vallegrande.edu.pe','1976-02-18','M','A','020303'),
     ('79876542','Salvador','Valenzuela','938835259','Salvador.Valenzuela@vallegrande.edu.pe','1972-04-08','M','A','020303'),
     ('15399381','Carlos','Lazo','922998179','Carlos.lazo@vallegrande.edu.pe','1998-12-19','M','A','020203'),
     ('15993861','Jhon','Cena','929986683','Jhon.cena@vallegrande.edu.pe','1972-04-08','M','A','010605'),
     ('74891883','Luis','Zola','933998171','Luis.loza@vallegrande.edu.pe','1978-11-14','M','A','010605'),
     ('15993188','Roberto','Aveiro','935933818','Roberto.aveiro@vallegrande.edu.pe','1975-08-02','M','A','010605'),
     ('12995881','Oscar','Washinton','992515931','Oscar.washinton@vallegrande.edu.pe','1960-02-18','M','A','010605'),
     ('74492926','Luzmileth','Quispe','992336917','Luzmileth.quispe@vallegrande.edu.pe','2000-04-22','F','A','010120'),
     ('17399168','Daneri','Sanchez','922995817','Daneri.sanchez@vallegrande.edu.pe','1995-08-12','F','A','010120');

select * from Vendedor;


Insert into VEHICULO
		(PLAVEH,SOATVEH,MARVEH)
	values
         ('A1A-123','000019302850000000000000','Honda'),
         ('B4C-136','000019837750000000000000','Hyundai'),
         ('A5B-532','000089322850000000000000','Honda'),
         ('B7A-462','000018279850000000000000','Ford'),
         ('D8B-315','000017332850000000000000','Toyota'),
         ('C3A-462','000099647820000000000000','Honda'),
         ('B2Z-437','000019302850000000000000','Honda'),
         ('J3C-874','000019302850000000000000','Toyota'),
         ('B9A-163','000019302850000000000000','Ford'),
         ('M6S-236','000019302850000000000000','Hyundai');
...
Insert into VIAJE
		(DIRVIA,CODUBI)
	values
         ('Mz "D" Lt 3, Los Eucaliptos','150507'),
         ('Mz "Z" Lt 35, Los Libertadores','150501'),
         ('Mz "F" Lt 12, Chaparral','150502'),
         ('Mz "H" Lt 53, Los Campeones','150508'),
         ('Mz "A" Lt 12, Santa Rosa','150514'),
         ('Mz "Q" Lt 16, Montalban','150515'),
         ('Mz "T" Lt 22, Barrancadero','150512'),
         ('Mz "D" Lt 3, Los Eucaliptos','150516'),
         ('Mz "B" Lt 38, Los Mejores','150514'),
         ('Mz "R" Lt 64, Los Finales','150511');

select * from Viaje;

Insert into PRODUCTO
		(NOMPRO,DESCPRO,PREPRO,STOCKPRO,AREAPRO,PABEPRO)
	values
         ('Gallinas','Gallinas de corral, bien alimentadas','10.50','100','C','C3'),
         ('Huevos','Huevos de calidad','7.30','100','C','C4');
         
select * from producto;


Insert into VENTA
		(FECHVENT,IDVEN,IDCLI,IDVIA)
	values
         ('2022-03-12','1','1','1'),
         ('2022-01-02','2','2','2'),
         ('2022-12-28','3','3','3'),
